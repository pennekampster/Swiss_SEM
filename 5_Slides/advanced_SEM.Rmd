...
- Direction of causality reversed: from latent variables to the observed variable (reflective indicators). 
- Indicator variables are emergent manifestation of the underlying phenomenon represented by the latent variable.   
- Indicator variables should be positively correlated to the latent variable (i.e., driver). Recode to achieve this. 
- Latent variable free of random or systematic measurement errors in contrast to its indicators.


## Latent variables

- Both endogenous and exogenous latent variables possible.
...
- Test that latent variable has given rise to emergent properties that, by virtue of a common cause, are correlated.  
