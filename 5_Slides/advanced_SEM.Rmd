...
- Measurement model, which focuses solely on relating indicators to latent variables.

## Confirmatory factor analysis

- Multi-indicator latent variables can test the hypothesis that a suite of indicator variables are generated by the same underlying process.    
- You are testing the idea that the latent variable has given rise to emergent properties that, by virtue of a common cause, are correlated.  
- This approach concerns only the measurement model and thus is a precursor to evaluation of any structural models in which the latent variables appear.  
