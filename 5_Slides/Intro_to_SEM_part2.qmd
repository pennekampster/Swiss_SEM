...
-   *Day 2*: 
    -  Latent and composite variables, interactions, complex sampling designs (lecture)
...
::: incremental
-   Conceptual model to link data with theory.
-   So far, only measured variables were considered.
-   However, some components of a meta-model abstract, multifaceted concepts (e.g., "biodiversity") may be difficult to quantify and measure directly.
-   SEM provides constructs such as latent and composite variables to address these situations.\
:::
