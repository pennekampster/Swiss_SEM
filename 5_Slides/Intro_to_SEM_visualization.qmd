...
Suggestions to draw an informative, interpretable and reproducible SEM diagram.
...
![](images/path_coeff_table.png){.absolute .absolute width="600"}
...
- Meta models:
  - Shows the core concepts and their relationships.
