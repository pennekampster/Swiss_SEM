...
1) Show constructs with appropriate complexity (e.g. without indicators) 
1) Include goodness of fit of the model 
...
- semptools package offers additional customization
:::
