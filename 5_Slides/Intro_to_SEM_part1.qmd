...
- Design and conduct experiment or observational study
- Test hypotheses
- Develop theory 
:::
...
-   Partial effects (i.e. effect of precipitation on biomass when nutrient addition is fixed) when > 1 independent variables.
...
## Compare model-implied to observed covariance 
...
- Wright's rules for tracing paths can be used to decompose total correlations into path coefficients.
- Modern SEM software calculates these automatically.
...
## Example: path tracing in a simple model {.smaller}
