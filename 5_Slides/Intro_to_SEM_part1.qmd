...
::: incremental
- Participants understand the pros and cons of SEMs for drawing inferences from data.
- Participants understand path models, as well as latent and composites variables.
- Participants can assess and interpret SEMs reported in the literature.
- Participants are able to fit SEMs to their datasets with the R package `lavaan` and present them graphically.
:::
