...
- Participants are able to fit, assess, interpret and visualize a SEM.
- Participants are able to apply the SEM approach to their datasets with the R package `lavaan`.
...
- Why is understanding causes important?
  + Be able to predic the behaviour of a system
...
::: {.incremental}
-   A series of equations united in a single causal network.
...
## Scatterplot matrix of observed variables
...
- The inferential heart of structural equation modeling are the model coefficients.
- Understanding the meaning of the model coefficients needed to interpret SEM.
...
- Some of the free parameters you are trying to estimate are interchangeable (e.g., and and b in `y = a*x + b*x + c`)
...
1)  How has aboveground biomass changed as a function of soil disturbance, nutrient addition and precipitation?
...
::: {.incremental}
1)  Function (biomass) is directly influenced by the environment (nutrients, precipitation, disturbance)
