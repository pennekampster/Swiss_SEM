...
How would you draw your model output for others to reproduce and evaluate this model?
...
\note{Thank the audience for being awake again.}
...
- Breaking up models into several panels or figures
- Try to have high information-to-ink ratio
- Display variables that is informative for reader rather than distracting:
...
\alert{There are no rules.} Here are our guidelines to help drawing an informatiove, interpretable and reproducible SEM diagram.
