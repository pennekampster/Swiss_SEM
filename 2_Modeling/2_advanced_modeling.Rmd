...
In comparison to latent variables, they arise from the indicators. For this reason, they are visualized by arrows pointing from the indicators to the composite ((so-called "formative indicators" [@grace21]).
