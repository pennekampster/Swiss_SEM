...
Indicators for a LV should be strongly correlated with each other. If we fail to find significant correlations based on standard tests and null hypothesis testing, we reject the hypothesis that the indicators are varying in concert and the data contradicts the claim of a latent cause [@grace21a].
...
(ii) local non-identification or
(iii) general misspecification [@grace21].
