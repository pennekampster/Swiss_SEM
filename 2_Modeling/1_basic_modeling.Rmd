...
* Shorten as it is growing a bit long, candidates are: model pruning, complex sampling structure
* My personal suggestion: add some manually calculated (very simple) examples and a bit of theory behind graphs, tracing rules and such
* Change default branch to `further`
...
3.84 is considered as the critical threshold, the "single-degree-of-freedom $\chi^2$ criterion". 
