...
<div class="alert alert-info">
  <strong>Exercise:</strong> would you infer that the data meet the assumption of being normally distributed from the results of the Henze-Zirkler test and the Q-Q plots? And why (not)?
</div>
