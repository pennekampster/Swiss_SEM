...
Inspecting our set of variables shows that correlations between all variables are not too strong.
...
## Rescale variables
To remove this difference in magnitude between the variables, we divide `mass.above` by 100 what changes the unit from g/m^2^ to 10 mg/m^2^ and from mm to 0.1 m respectively.
