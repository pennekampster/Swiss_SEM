...
Using analysis of covariances allows for estimation of both unstandardized (raw) and standardized coefficients [@grace21].
...
* Evenness is of little importance for the total biomass production


Advantages of SEM over LM are:

* SEM represents a network type approach with direct and indirect effects
* SEM allows for sequential learning
* LM more likely to detect interactions
